...
class LeaveRequest extends Model
{
    ...
    protected $fillable = ['uuid', 'id', 'note', 'start_date', 'reference', 'end_date', 'leave_status_id', 'leave_reason_id', 'leave_type_id','approval_date', 'user_id', 'attachment',  'updated_at', 'created_at'];
